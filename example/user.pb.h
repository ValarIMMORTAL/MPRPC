...
inline const std::string& ResultCode::errmesg() const {
  // @@protoc_insertion_point(field_get:User.ResultCode.errmesg)
...
void ResultCode::set_errmesg(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.errmesg_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:User.ResultCode.errmesg)
}
inline std::string* ResultCode::mutable_errmesg() {
  std::string* _s = _internal_mutable_errmesg();
  // @@protoc_insertion_point(field_mutable:User.ResultCode.errmesg)
  return _s;
}
...
inline std::string* ResultCode::release_errmesg() {
  // @@protoc_insertion_point(field_release:User.ResultCode.errmesg)
...
inline void ResultCode::set_allocated_errmesg(std::string* errmesg) {
  ...
  // @@protoc_insertion_point(field_set_allocated:User.ResultCode.errmesg)
}
