...
const uint32_t TableStruct_friend_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Friend::ResultCode, _impl_.errcode_),
  PROTOBUF_FIELD_OFFSET(::Friend::ResultCode, _impl_.errmsg_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::Friend::GetFriendListRequest, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Friend::GetFriendListRequest, _impl_.userid_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::Friend::GetFriendListResponse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Friend::GetFriendListResponse, _impl_.result_),
  PROTOBUF_FIELD_OFFSET(::Friend::GetFriendListResponse, _impl_.friends_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::Friend::ResultCode)},
  { 8, -1, -1, sizeof(::Friend::GetFriendListRequest)},
  { 15, -1, -1, sizeof(::Friend::GetFriendListResponse)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::Friend::_ResultCode_default_instance_._instance,
  &::Friend::_GetFriendListRequest_default_instance_._instance,
  &::Friend::_GetFriendListResponse_default_instance_._instance,
};

const char descriptor_table_protodef_friend_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\014friend.proto\022\006Friend\"-\n\nResultCode\022\017\n\007"
  "errcode\030\001 \001(\005\022\016\n\006errmsg\030\002 \001(\014\"&\n\024GetFrie"
  "ndListRequest\022\016\n\006userid\030\001 \001(\r\"L\n\025GetFrie"
  "ndListResponse\022\"\n\006result\030\001 \001(\0132\022.Friend."
  "ResultCode\022\017\n\007friends\030\002 \003(\0142`\n\020FriendSer"
  "viceRpc\022L\n\rGetFriendList\022\034.Friend.GetFri"
  "endListRequest\032\035.Friend.GetFriendListRes"
...
GetFriendListRequest::GetFriendListRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:Friend.GetFriendListRequest)
}
GetFriendListRequest::GetFriendListRequest(const GetFriendListRequest& from)
  ...
  // @@protoc_insertion_point(copy_constructor:Friend.GetFriendListRequest)
}
...
GetFriendListRequest::~GetFriendListRequest() {
  // @@protoc_insertion_point(destructor:Friend.GetFriendListRequest)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
// @@protoc_insertion_point(message_clear_start:Friend.GetFriendListRequest)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
uint8_t* GetFriendListRequest::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:Friend.GetFriendListRequest)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Friend.GetFriendListRequest)
  return target;
}

size_t GetFriendListRequest::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:Friend.GetFriendListRequest)
  size_t total_size = 0;
...
void GetFriendListRequest::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:Friend.GetFriendListRequest)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:Friend.GetFriendListRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
class GetFriendListResponse::_Internal {
 public:
  static const ::Friend::ResultCode& result(const GetFriendListResponse* msg);
};
...
GetFriendListResponse::GetFriendListResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:Friend.GetFriendListResponse)
}
GetFriendListResponse::GetFriendListResponse(const GetFriendListResponse& from)
  ...
  if (from._internal_has_result()) {
    _this->_impl_.result_ = new ::Friend::ResultCode(*from._impl_.result_);
  }
  // @@protoc_insertion_point(copy_constructor:Friend.GetFriendListResponse)
}
...
GetFriendListResponse::~GetFriendListResponse() {
  // @@protoc_insertion_point(destructor:Friend.GetFriendListResponse)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
// @@protoc_insertion_point(message_clear_start:Friend.GetFriendListResponse)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
uint8_t* GetFriendListResponse::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:Friend.GetFriendListResponse)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Friend.GetFriendListResponse)
  return target;
}

size_t GetFriendListResponse::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:Friend.GetFriendListResponse)
  size_t total_size = 0;
...
void GetFriendListResponse::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:Friend.GetFriendListResponse)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (from._internal_has_result()) {
    _this->_internal_mutable_result()->::Friend::ResultCode::MergeFrom(
...
// @@protoc_insertion_point(class_specific_copy_from_start:Friend.GetFriendListResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void FriendServiceRpc::GetFriendList(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                         const ::Friend::GetFriendListRequest*,
                         ::Friend::GetFriendListResponse*,
  ...
  switch(method->index()) {
    case 0:
      GetFriendList(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::Friend::GetFriendListRequest*>(
                 request),
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<::Friend::GetFriendListResponse*>(
                 response),
             done);
      break;
    default:
...
const ::PROTOBUF_NAMESPACE_ID::Message& FriendServiceRpc::GetRequestPrototype(
  ...
  switch(method->index()) {
    case 0:
      return ::Friend::GetFriendListRequest::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
...
const ::PROTOBUF_NAMESPACE_ID::Message& FriendServiceRpc::GetResponsePrototype(
  ...
  switch(method->index()) {
    case 0:
      return ::Friend::GetFriendListResponse::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
      return *::PROTOBUF_NAMESPACE_ID::MessageFactory::generated_factory()
...
template<> PROTOBUF_NOINLINE ::Friend::ResultCode*
Arena::CreateMaybeMessage< ::Friend::ResultCode >(Arena* arena) {
  return Arena::CreateMessageInternal< ::Friend::ResultCode >(arena);
}
template<> PROTOBUF_NOINLINE ::Friend::GetFriendListRequest*
Arena::CreateMaybeMessage< ::Friend::GetFriendListRequest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::Friend::GetFriendListRequest >(arena);
}
template<> PROTOBUF_NOINLINE ::Friend::GetFriendListResponse*
Arena::CreateMaybeMessage< ::Friend::GetFriendListResponse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::Friend::GetFriendListResponse >(arena);
}
